...
export const Auswertungen = () => {
    ...
    const handleExportToExcel = () => {
        ...
        const auslastungSheetData = tableData.map(p => ({
            ...
            "Datenprodukte": p.produktDetails.map(pd => `${pd.name} (${pd.rollen})`).join('; ')
        }));
