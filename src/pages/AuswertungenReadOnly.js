// src/pages/AuswertungenReadOnly.js - Read-Only Version für Confluence
...
export const AuswertungenReadOnly = () => {
  const {
    personen,
    datenprodukte,
    zuordnungen,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-wrap justify-between items-center mb-8 gap-4">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Team-Auswertungen</h1>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex items-center gap-2">
                            {person["Anzahl Produkte"] > 3 && (
                              <span className="text-red-500" title="Hohe Auslastung">❗️</span>
                            )}
