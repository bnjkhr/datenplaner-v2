            ...
            <div key={dp.id} className="bg-white shadow-lg rounded-xl p-6 flex flex-col justify-between">
                    ...
                    <ul className="list-none space-y-1">
                      {zuordnungen
                        ...
                        .map((zuordnung) => (
                          ...
                          >
                            <span>
                              {getPersonName(zuordnung.personId)} ({getRolleName(zuordnung.rolleId)})
                            </span>
                            <button
              ...
              <div className="mt-auto pt-4 border-t flex flex-wrap gap-2 justify-end">
                ...
                <button
                  ...
                  className={`text-sm ${dp.notizen ? 'text-black' : 'text-gray-400'} hover:text-black flex items-center`}
                  title="Notizen"
                >
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleAssignRoleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="assign-person" className="block text-sm">Person</label>
                  <select
                    id="assign-person"
                ...
                <div>
                  <label htmlFor="assign-role" className="block text-sm">Rolle</label>
                  <select
                    id="assign-role"
                    value={assignRolleId}
                ...
                <div className="flex justify-end space-x-3 pt-3">
                  <button type="button" onClick={() => setSelectedProduktForAssignment(null)} className="px-4 py-2 border rounded-md">
                    Abbrechen
                  </button>
